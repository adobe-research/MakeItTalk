...
parser.add_argument('--load_a2l_C_name', type=str,
                    default='/mnt/ntfs/Dataset/TalkingToon/Obama_for_train/ckpt/local_obama_norm_4_batch2/ckpt_e_100.pth') # 'examples/ckpt/ckpt_audio2landmark_c.pth')
...
# save model
parser.add_argument('--jpg_freq', type=int, default=10, help='')
parser.add_argument('--ckpt_epoch_freq', type=int, default=10, help='')
