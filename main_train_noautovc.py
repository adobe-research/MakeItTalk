...
from approaches.train_noautovc import Speaker_aware_branch
...
parser.add_argument('--verbose', type=int, default=2, help='0 - detail, 2 - simplify')
...
parser.add_argument('--load_a2l_G_name', type=str,
                    default='/mnt/ntfs/Dataset/TalkingToon/VoxCeleb2/ckpt/noautovc_initall_on256/ckpt_last_epoch.pth') #

parser.add_argument('--name', type=str, default='noautovc_initall_on256_test')
