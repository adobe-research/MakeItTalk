...
fs = ['rand2_pred_fls_tim_1401_1_16k_45hn7-LXDX8.mp4' ]
...
for f in fs:
    ...
    # src_dir = r'E:\Dataset\TalkingToon\VoxCeleb2\nn_result\Xintong_dali\exp3_Jan02'
    # cap = cv2.VideoCapture(os.path.join(src_dir, 'o.mp4'))
    # writer = cv2.VideoWriter(os.path.join(r'E:\Dataset\TalkingToon\VoxCeleb2\nn_result\Xintong_dali\exp3_Jan02', 'tmp.mp4'),
    #                                  cv2.VideoWriter_fourcc('M', 'J', 'P', 'G'), 62.5, (256, 256))
